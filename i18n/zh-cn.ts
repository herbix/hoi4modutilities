...
const table: Partial<typeof __table> = {
    ...
    "days": "天",
    "error": "错误",
    "eventtree.aichancescript": "AI 权重脚本：",
    "eventtree.closedetails": "关闭详情",
    "eventtree.delay": "延迟：",
    "eventtree.description": "描述：",
    "eventtree.description.trigger": "描述（{0}）：",
    "eventtree.details": "详情",
    ...
    "eventtree.scope": "目标：",
    "eventtree.showdetails": "显示详情",
    "eventtree.title": "标题：",
    "eventtree.trigger": "条件：",
    ...
    "worldmap.add.failed.nocache": "添加失败。没有已缓存的地图数据。请重新加载世界地图并重试。",
    "worldmap.edit.failed.cannotremovevp": "你不能移除有胜利点的地块。",
    "worldmap.edit.failed.nocache": "编辑失败。没有已缓存的地图数据。请重新加载世界地图并重试。",
    ...
    "worldmap.mustopenafolder.add": "要添加{0}文件，必须先打开文件夹。",
    "worldmap.mustopenafolder.edit": "要编辑{0}文件，必须先打开文件夹。",
    "worldmap.openfiletype.country": "国家",
    "worldmap.openfiletype.misc": "地图相关的文件",
    "worldmap.openfiletype.provincedefinition": "地块定义",
    ...
    "worldmap.tooltip.country": "国家",
    "worldmap.tooltip.demilitarizedzone": "非军事区",
    ...
    "worldmap.topbar.add.title": "添加 (A)",
    ...
    "worldmap.topbar.edit.title": "编辑 (E)",
    "worldmap.topbar.linkstatestrategicregion.title": "编辑时，省份边界遵循战略区域 (S)",
    ...
    "worldmap.warnings.onepixelprovince": "在{0}, {1}发现孤立的单像素地块颜色。",
