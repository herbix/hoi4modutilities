...
export = {
    ...
    'worldmap.failedtoopenstate': '打开省份文件失败：{0}。',
    'worldmap.mustopenafolder': '要打开省份文件，必须先打开文件夹。',
    ...
    'worldmap.selectafolder': '选择复制省份的目标文件夹',
    ...
    'worldmap.warnings.provinceidconflict': "有多个地块使用编号{0}。设置后者编号为{1}。",
