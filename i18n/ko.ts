...
const table: Partial<typeof __table> = {
    ...
    "infile": "{0} 파일 내:\n",
    "loading": "로딩중...",
    "localisationIndex.builddone": "현지화 인덱스 구축 완료.",
    "localisationIndex.building": "현지화 인덱스 구축 중...",
    "localisationIndex.mod": "[모드]",
    "localisationIndex.parseFailure": "구문 분석에 실패했습니다! 파일에 문제가 있는지 확인하세요!",
    "localisationIndex.vanilla": "[바닐라]",
    "localisationIndex.workspace.builddone": "작업 공간 현지화 인덱스 구축 완료.",
    "localisationIndex.workspace.building": "작업 공간 현지화 인덱스 구축 중...",
    ...
    "miopreview.warnings.traitAndIncludeCheck1": "설계사 {0} 에 포함 가능한 속성이 아닙니다. trait 대신 add_trait 혹은 override_trait 사용하여야 합니다.",
    "miopreview.warnings.traitAndIncludeCheck2": "설계사 {0} 에 포함 가능한 속성이 아닙니다. add_trait 혹은 override_trait대신 trait을 사용하여야 합니다.",
