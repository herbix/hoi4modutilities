...
const table: Partial<typeof __table> = {
    ...
    "worldmap.warnings.onepixelprovince": "{0}, {1}에서 고립된 1픽셀 프로빈스 색상이 발견됨.",
    ...
    "worldmap.warnings.provincetoosmall": "프로빈스는 (x={1},y={2}) 주변에 {0}픽셀만 있음. 최소 {3}픽셀이어야 함.",
